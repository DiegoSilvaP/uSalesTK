# Generated by Django 2.1 on 2019-03-25 05:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Creado')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Actualizado')),
                ('category', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='get_categories', to='publications.Category', verbose_name='Categoría')),
        ...
        migrations.AddField(
            ...
            name='subcategory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='get_subcategories', to='publications.SubCategory', verbose_name='Subcategoría'),
        ),
    ]
