# Generated by Django 2.1 on 2019-03-07 07:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Precio por unidad')),
                ('picture', models.ImageField(blank=True, null=True, upload_to='publications', verbose_name='Imagen del encabezado')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Creado')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Actualizado')),
                ('category', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='get_posts', to='publications.Category', verbose_name='Categoria')),
